...
# Per device TYPE, what Install puts on the Pi. The key is the device's `type` in the rig YAML,
# which defaults to the device's name; a new device adds its entries here. Video devices
# (`video: true`) get ffmpeg + v4l-utils regardless.
...
I2C_DEVICE_TYPES: set = {"gyroscope_i2c"}     # types that need the Pi's I2C bus enabled
