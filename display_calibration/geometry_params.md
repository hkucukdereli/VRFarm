...
| `altitude_min_deg` | ° | Bottom edge elevation angle from mouse eye level (horizon). |
...
| Field | Unit | Meaning |
|-------|------|---------|
| `eye_height_above_ball_cm` | cm | Mouse eye height above the center of the trackball. |
| `ball_diameter_cm` | cm | Trackball diameter. |
